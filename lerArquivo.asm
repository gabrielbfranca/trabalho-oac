...
gambiarra: .space 2 #o nomeDaEntrada termina numa word de 2 bytes, por isso � preciso 
#adicionar esse espa�amento de 2 bytes para que as proximas entradas estejam alinhadas na mem�ria
...
move $a1, $t0
li $a2, 4096
syscall #v0 recebe o n�mero de caracteres lidas
